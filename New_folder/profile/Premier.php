<?php
       session_start();
       if (isset($_COOKIE['teeckle_user'])) {
            $userreg = $_COOKIE['teeckle_user'];
       }
       else {
...
<html>
  ...
  <div class="top">
  <div class="header">
  <a href="https://www.teeckle.me/teeckleProfile.php">
    <img src="/images/Me.png" class="logo" />
    </a>
    <a class="profnav" id="profile"><img src="/images/Profile-Icons-Blue.png" style="float:left;width: 49px;margin-top: 10px;"/> </a> 
    <a class="profnav"  id="messages"><img src="/images/Message-Icons.png" style="
    float:left;
    "/></a><span style="float:left;margin:30px 0px 0px -15px;" id="nums"></span>
<a class="profnav" id="contacts"> <img src="/images/book_grey2_icon.png" style="
float:left;
margin: 21px 0px 0px 20px;
width: 45px;
height: 28px;" /> </a><span id="conts" style="position: absolute;
margin-left:175px;"></span> 
<a class="profnav" id="teeckles"><img src="/images/feather.png" style="width: 50px;
position: absolute;
margin-top: -15px;
margin-left: 45px;"/></a>
<span id="teeks" style="margin: -2px 0px 0px 85px;
position: absolute;"></span>
    <p class="sections">
      <a href="https://www.teeckle.me/groups.php"> Groups </a>|
...
<p class="section2">
    <a id="profile"><img src="/images/Profile-Icons-Blue.png" style="width: 49px;
position: absolute;
margin-top: -21px;"/> </a>  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
    <a id="teeckles"><img src="/images/feather.png" style="width: 50px;
position: absolute;
margin-top: -15px;
margin-left: 45px;"/></a>
<span id="teeks" style="margin: -2px 0px 0px 85px;
